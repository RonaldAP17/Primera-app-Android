    ...
    private void leerDatos() {
        ...
        if(cursor != null){
            if(cursor.moveToFirst()){
                ...
                String[] datos = {"idmovimiento","movimiento","descripcion", "fecha", "monto"};
                int[] ids = {R.id.tvMovimiento,R.id.tvMovimientoEstado, R.id.tvDescripcion, R.id.tvFecha, R.id.tvMonto};
                ...
                ListAdapter listAdapter = new SimpleAdapter(
                    ...
                    mLvReporte.setAdapter(listAdapter);
            }
        }
    }
}